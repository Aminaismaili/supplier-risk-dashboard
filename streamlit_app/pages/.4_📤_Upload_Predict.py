    ...
    if uploaded_file is not None:
        try:
            ...
            if st.button("🚀 Lancer les Prédictions", type="primary", use_container_width=True):
                ...
                for idx, row in df_upload.head(batch_size).iterrows():
                    ...
                    result = APIClient.predict_supplier(supplier_data)
        ...
        st.markdown("""
            <div style='background: #f8f9fa; padding: 2rem; border-radius: 10px; margin-top: 2rem;'>
                ...
                <p><b>Note :</b> Pour de meilleures performances, limitez à 50 fournisseurs maximum par batch.</p>
            </div>
        """, unsafe_allow_html=True)

st.markdown("<br><br>", unsafe_allow_html=True)
st.caption("🤖 Batch predictions powered by AI • Maximum 50 suppliers per batch for optimal performance")